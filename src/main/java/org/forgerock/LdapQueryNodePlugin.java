 ...
 * @since AM 5.5.0
 */
public class LdapQueryNodePlugin extends AbstractNodeAmPlugin {
	...
	protected Map<String, Iterable<? extends Class<? extends Node>>> getNodesByVersion() {
		return Collections.singletonMap(LdapQueryNodePlugin.currentVersion, 
				Collections.singletonList(LdapQueryNode.class));
	}
	...
	public String getPluginVersion() {
		return LdapQueryNodePlugin.currentVersion;
	}
}
